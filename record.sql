...
INSERT INTO disc (disc_id, disc_title, disc_year, disc_picture, disc_label, disc_genre, disc_price, artist_id) VALUES
	...
	(13, 'Sticky Fingers', 1971, 'Sticky Fingers.jpeg', 'Rolling Stones Records', 'Blues Rock, Classic Rock', 33.00, 1),
	(14, 'Beggars Banquet', 1968, 'Beggars Banquet.jpeg', 'Rolling Stones Records', 'Blues Rock, Classic Rock', 33.00, 1),
	(15, 'Tattoo You', 1981, 'Tattoo You.jpeg', 'Rolling Stones Records', 'Blues Rock, Classic Rock', 33.00, 1)
;

-- Table pour l'éxercice session
